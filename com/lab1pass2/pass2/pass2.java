...
public class pass2 {
    ...
    {
        BufferedReader b1 = new BufferedReader(new FileReader("inter.txt")); 
        BufferedReader b2 = new BufferedReader(new FileReader("sym.txt")); 
        BufferedReader b3 = new BufferedReader(new FileReader("lit.txt")); 
        FileWriter f1 = new FileWriter("passt.txt"); 
